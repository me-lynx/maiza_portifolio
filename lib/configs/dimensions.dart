...
class Dimensions {
  ...
  static double space([double multiplier = 1.0]) {
    return Dimensions.padding! * 3 * multiplier;
  }

  static double normalize(double unit) {
    return (Dimensions.ratio * unit * 0.77) + unit;
  }

  static double fontSize(double unit) {
    return (Dimensions.ratio * unit * 0.125) + unit * 1.90;
  }
}
